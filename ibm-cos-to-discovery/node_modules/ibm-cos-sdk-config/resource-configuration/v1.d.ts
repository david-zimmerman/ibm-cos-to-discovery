 ...
 */
declare class ResourceConfigurationV1 extends BaseService {
    static URL: string;
    name: string;
     ...
     */
    getBucketConfig(params: ResourceConfigurationV1.GetBucketConfigParams, callback?: ResourceConfigurationV1.Callback<ResourceConfigurationV1.Bucket>): Promise<any> | void;
    /**
     ...
     * @returns {Promise<any>|void}
     */
    updateBucketConfig(params: ResourceConfigurationV1.UpdateBucketConfigParams, callback?: ResourceConfigurationV1.Callback<ResourceConfigurationV1.Empty>): Promise<any> | void;
}
/*************************
 * interfaces
 ************************/
declare namespace ResourceConfigurationV1 {
    ...
    interface GetBucketConfigParams {
        /** Name of a bucket. */
        bucket: string;
        headers?: Object;
